...
Game.prototype = {
    ...
    spawnRandGlider: function() {
        var xCenter = getRandomInt(3, this.matrix.length - 3);
        var yCenter = getRandomInt(0, this.cfg.margin - 3);

        if (xCenter <= this.cfg.margin) {
            yCenter = getRandomInt(3, this.matrix.length - 3);
        }
